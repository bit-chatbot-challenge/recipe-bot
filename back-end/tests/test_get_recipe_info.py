...
class TestGetRecipeDetails(unittest.TestCase):
	...
	def test_get_scaled_ingredients(self):
		expected_ingredients_list = [ '9.0 tbsps butter',
									  ...
									  '9.0 cups water']
		scaled_ingredients_list = get_scaled_ingredients(self.mock_response, self.desired_servings)
	...
	# Test getting the recipe URL
	def test_create_url(self):
		expected_url = 'https://www.mccormick.com/recipes/soups-stews/easy-french-onion-soup'
		self.assertEqual(expected_url, get_recipe_url(self.mock_response))

	# Test getting recipe details as a dictionary
	def test_get_recipe_details(self):
		expected_details = { 'name': 'Easy French Onion Soup',
		...
		recipe_details = get_recipe_details(self.mock_response, self.desired_servings)
		self.assertEqual(expected_details, recipe_details)
